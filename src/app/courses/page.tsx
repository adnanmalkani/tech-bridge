  ...
  const courses = [
    {
      ...
      description:
        "Master the art of visual communication with comprehensive training in Adobe Creative Suite, branding, and digital design.",
      modules: [
    ...
    },
    {
      ...
      description:
        "Become a certified digital marketing expert with hands-on training in SEO, SEM, social media, and analytics.",
      modules: [
    ...
    },
    {
      ...
      description:
        "Learn full-stack web development with modern technologies and frameworks to build dynamic, responsive websites.",
      modules: [
    ...
    },
    {
      ...
      description:
        "Master e-commerce platforms and online business strategies to build and manage successful online stores.",
      modules: [
    ...
    },
    {
      ...
      description:
        "Build native and cross-platform mobile applications for iOS and Android using modern development frameworks.",
      modules: [
    ...
    },
    {
      ...
      description:
        "Learn to analyze data and create compelling visualizations to drive business decisions and insights.",
      modules: [
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            designed to give you the skills employers are looking for.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our comprehensive course catalog and find the perfect
            ...
            {[
              {
                step: "01",
                title: "Choose Course",
                desc: "Select the course that matches your career goals",
              },
              {
                step: "02",
                title: "Apply Online",
              ...
              },
              {
                step: "03",
                title: "Interview",
                desc: "Brief discussion about your goals and expectations",
              },
              {
                step: "04",
                title: "Start Learning",
                desc: "Begin your transformative learning journey",
              },
            ].map((item, index) => (
