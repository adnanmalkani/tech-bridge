  ...
  const faqs = [
    {
      ...
      answer: "Basic computer literacy and intermediate education (12th grade) are required for most courses."
    },
    {
      question: "Do you provide job placement assistance?",
      answer: "Yes, we have a 95% job placement rate and maintain partnerships with over 50 companies."
    },
    {
      question: "Are the courses available online?",
      answer: "We offer both in-person and online learning options to accommodate different learning preferences."
    },
    {
      question: "What is the fee structure?",
      answer: "Course fees vary by program. We offer flexible payment plans and scholarship opportunities."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">Contact Us</Badge>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-2xl text-gray-900">Visit Our Campus</CardTitle>
                  <p className="text-gray-600">Come and see our state-of-the-art facilities</p>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">Block 13-A, Gulshan-e-Iqbal, Karachi, Pakistan</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-blue-600">🚗</span>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Our admissions team is ready to help you find the perfect course for your career goals
          </p>
