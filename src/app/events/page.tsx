...
export default function EventsPage() {
  const upcomingEvents = [
    {
      ...
      description: "Learn advanced digital marketing strategies from industry experts. Topics include SEO, SEM, social media marketing, and analytics.",
    ...
    },
    {
      ...
      description: "Get a sneak peek into our comprehensive web development bootcamp. Learn about modern frameworks and career opportunities.",
    ...
    },
    {
      ...
      description: "Bring your portfolio for expert review and feedback. Learn how to create compelling design portfolios that get you hired.",
    ...
    },
    {
      ...
      description: "Meet with top tech companies and explore career opportunities. Open to all Tech Bridge students and graduates.",
  ...
  const pastEvents = [
    {
      ...
      attendees: "200+",
      image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=300&h=200&fit=crop&crop=center",
      highlights: ["15 Industry Speakers", "Live Product Launches", "Networking Sessions"]
    },
    {
      id: 6,
      ...
      highlights: ["React Native Workshop", "Flutter Masterclass", "App Store Optimization"]
    },
    {
      id: 7,
      ...
      attendees: "100+",
      image: "https://images.unsplash.com/photo-1551818255-e6e10975cd17?w=300&h=200&fit=crop&crop=center",
      highlights: ["Python for Data Science", "Tableau Visualization", "Real-world Projects"]
    }
  ];
  ...
  const eventTypes = [
    ...
    },
    {
      type: "Networking",
      icon: "🤝",
      description: "Build professional connections with peers and industry leaders",
      count: "6+ per month"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">Events & Workshops</Badge>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Learn, Network &
            <span className="text-blue-600"> Grow Together</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Join our regular events, workshops, and seminars to stay updated with 
            industry trends and connect with like-minded professionals.
          </p>
        </div>
      </section>
            ...
            {eventTypes.map((eventType, index) => (
              <Card key={index} className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">{eventType.type}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {upcomingEvents.map((event) => (
              <Card key={event.id} className={`border-0 shadow-xl bg-white/90 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 ${event.featured ? 'ring-2 ring-blue-600' : ''}`}>
                {event.featured && (
                ...
                <CardContent>
                  ...
                  <div className="space-y-3">
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-sm font-semibold text-blue-800">Speaker</div>
                      <div className="text-sm text-blue-600">{event.speaker}</div>
                    </div>
                    
                    <div className="flex justify-between items-center">
                      <div>
                        <div className="text-sm font-semibold text-gray-800">Price</div>
                        <div className="text-sm text-green-600">{event.price}</div>
                      </div>
                      <div className="text-right">
                        <div className="text-sm font-semibold text-gray-800">Availability</div>
                        <div className="text-sm text-orange-600">{event.seats}</div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 bg-white/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Take a look at some of our successful events and the impact they've made
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {pastEvents.map((event) => (
              <Card key={event.id} className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
                <div className="relative">
                  <img 
                    src={event.image} 
                    alt={event.title}
            ...
            <CardContent className="pt-6">
              <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center">
                <div className="text-center text-gray-500">
                  ...
                  <p className="text-sm">View all upcoming events and workshops</p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                We welcome industry professionals and organizations to collaborate with us 
                in hosting educational events and workshops.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <span className="text-blue-600">✓</span>
                  <span className="text-gray-700">Access to our student community</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-blue-600">✓</span>
            ...
            <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Event Inquiry</CardTitle>
                <p className="text-gray-600">Get in touch to discuss your event ideas</p>
              </CardHeader>
              <CardContent>
