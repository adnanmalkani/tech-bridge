  ...
  const courses = [
    {
      ...
      description:
        "Master the art of online marketing with comprehensive training in SEO, social media, and digital advertising.",
      duration: "3 Months",
    ...
    },
    {
      ...
      description:
        "Learn professional graphic design using industry-standard tools like Adobe Photoshop, Illustrator, and InDesign.",
      duration: "4 Months",
      level: "Beginner to Advanced",
      icon: "🎨",
    ...
    },
    {
      ...
      description:
        "Build modern, responsive websites using HTML, CSS, JavaScript, and popular frameworks like React.",
      duration: "6 Months",
      level: "Beginner to Advanced",
      icon: "💻",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Choose from our industry-leading courses designed to give you
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-16">
          {courses.map((course, index) => (
            ...
            >
              {/* Course Icon */}
              <div
                className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-r ${course.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center text-lg sm:text-xl lg:text-2xl mb-4 sm:mb-6 group-hover:scale-110 transition-transform-smooth shadow-lg`}
              >
                {course.icon}
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                {/* CTA Button */}
                <Button
                  className={`w-full bg-gradient-to-r ${course.gradient} hover:shadow-lg text-white py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold transition-all-smooth group-hover:scale-105`}
                >
                  Learn More
                </Button>
              </div>
