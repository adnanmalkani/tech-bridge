...
const AdmissionsSection = () => {
  ...
  const admissionSteps = [
    ...
    },
    {
      ...
      description: "Fill out our simple online application form with your basic information and educational background.",
      icon: "📝",
    ...
    },
    {
      ...
      description: "Complete a brief skills assessment and participate in a consultation call with our admissions team.",
      icon: "🎯",
    ...
    },
    {
      ...
      description: "Receive your acceptance letter and complete the enrollment process to secure your spot.",
      icon: "✅",
  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply animate-float" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-12 sm:mb-16 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`}>
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
            Join thousands of successful graduates who have transformed their careers through our comprehensive digital skills programs.
          </p>
        </div>

        {/* Admission Process */}
        <div className="mb-20">
          <div className={`text-center mb-8 sm:mb-12 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`} style={{animationDelay: '200ms'}}>
            ...
            {admissionSteps.map((step, index) => (
              ...
              >
                <div className="glass rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 hover-lift transition-all-smooth border border-white/20 h-full relative">
                  <div className={`absolute -top-3 -right-3 sm:-top-4 sm:-right-4 w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r ${step.gradient} text-white rounded-xl sm:rounded-2xl flex items-center justify-center font-bold text-sm sm:text-lg shadow-lg group-hover:scale-110 transition-transform-smooth`}>
                    {step.step}
                  </div>
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-r ${step.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform-smooth shadow-lg`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 mb-16 sm:mb-20">
          {/* Requirements */}
          <div className={`${isVisible ? 'animate-slideInLeft' : 'opacity-0'}`} style={{animationDelay: '800ms'}}>
              ...
              <div className="space-y-4 sm:space-y-6">
                {requirements.map((requirement, index) => (
                  <div key={index} className="flex items-center space-x-3 sm:space-x-4 group">
                    ...
                    <span className="text-gray-700 text-base sm:text-lg group-hover:text-gray-900 transition-colors">{requirement}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* Benefits */}
          <div className={`${isVisible ? 'animate-slideInRight' : 'opacity-0'}`} style={{animationDelay: '1000ms'}}>
            <div className="glass rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 hover-lift transition-all-smooth border border-white/20">
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start space-x-3 sm:space-x-4 group">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 text-base sm:text-lg mb-1 sm:mb-2 group-hover:text-blue-600 transition-colors">{benefit.title}</h4>
        ...
        {/* Call to Action */}
        <div className={`${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`} style={{animationDelay: '1200ms'}}>
          <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 text-center bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-200/20 hover-lift transition-all-smooth">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
              Don't wait! Limited seats available for the next batch.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-8 text-gray-600">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="font-medium text-sm sm:text-base">+92 300 2627941</span>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="font-medium text-sm sm:text-base break-all">info@techbridgepakistan.com</span>
              </div>
            </div>
          </div>
        </div>
